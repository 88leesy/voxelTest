...
#define EPSILON (0.08)  // distance for clustering, metre^2
	...
	*/
	string save_path = "F:/_voxelFeatureMap7/" + dataname + "_3d_nearest_centroid.txt";
	...
	std::ofstream oStream_dbData("F:/_voxelFeatureMap7/" + dataname + "db_data.txt", ios::out | ios::binary); //ios::app => 이어쓰기
	...
	for (int i = 0; i < ncam; ++i)
	{
		...
		*/
		...
		string save_path = "F:/_voxelFeatureMap7/" + dataname + names[i];
		string save_path2 = "F:/_voxelFeatureMap7/" + dataname + names[i];
