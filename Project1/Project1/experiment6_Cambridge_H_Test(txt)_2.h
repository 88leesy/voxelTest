...
bool LoadModelFile(string& image_filePath, string& camera_filePath, string& points3D_filePath, string& data_name, int cubeSize);
...
#define EPSILON (0.08)  // distance for clustering, metre^2
	...
	if (Voxel_Labeling_Method == 1)
		absPath = "F:/Cambridge_SP+SG_sfmDatasets/" + data_name + "sfm_superpoint+superglue/";  
