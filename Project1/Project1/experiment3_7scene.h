	...
	vector<string>& names, vector<int>& ptc, int cubeSize)
{
	...
	//std::ofstream oStream_poseData("F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + "poses.txt", ios::out | ios::binary); //ios::app => 이어쓰기
	//for (int i = 0; i < ncam; ++i)
	//{
	//	float q[4]; float t[3];
	...
	//	
	//	oStream_poseData << reName << " " << q[0] << " " << q[1] << " " << q[2] << " " << q[3] << " "
	//		<< t[0] << " " << t[1] << " " << t[2] << endl;
	//}
	//oStream_poseData.close();
...
#define EPSILON (0.08)  // distance for clustering, metre^2
	...
	float reSize_H = 192, reSize_W = 256;
	...
	*/
	string save_3dpt_path = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + "_3d_nearest_centroid.txt";
	...
	std::ofstream oStream_dbData("F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + "db_data.txt", ios::out | ios::binary); //ios::app => 이어쓰기

	//이미지별로 불러오기
	for (int i = 0; i < ncam; ++i)
	{
		//string img_path = "F:/_RGBD_Dataset7_Scenes/" + dataname + "jpgFiles/" + names[i];
		string img_path = "F:/_RGBD_Dataset7_Scenes/" + dataname + names[i];
		...
		*/
		...
		DB_img.focal_len = focal_len / scaleX;
		DB_img.focal_len = focal_len / scaleY;
		...
		//string save_path_rgb = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + line_str[0] + ".jpg";
		//string save_path = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + "label_" + line_str[0] + ".jpg";
		//string save_path2 = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + "kp_" + line_str[0] + ".jpg";
		...
		string save_path_rgb = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + img_path_split[0] + "/" + img_path_split[1] + ".png";
		string save_path = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname +  img_path_split[0] + "/" + "label_" + img_path_split[1] + ".png";
		string save_path2 = "F:/_voxelFeatureMap_RGBD_Dataset7_Scenes/_single_Voxel_set/" + dataname + img_path_split[0] + "/" + "kp_" + img_path_split[1] + ".png";
